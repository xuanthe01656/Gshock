            ...
            <div class="col-lg-4">
                <div class="card card-transparent card-block card-stretch card-height border-none">
                    <div class="card-body p-0 mt-lg-2 mt-0">
                        ...
                        <h3 class="mb-3">Chào! ${pageContext.request.userPrincipal.name}</h3>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-info-light">
                                        <img src="${contextPath }/images/product/1.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-danger-light">
                                        <img src="${contextPath }/images/product/2.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-success-light">
                                        <img src="${contextPath }/images/product/3.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                                ...
                                <div class="card card-block card-stretch card-height mb-0">
                                    <div class="card-body">
                                        <div class="bg-warning-light rounded">
                                            <img src="${contextPath }/images/table/product/" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                                        <div class="style-text text-left mt-3">
                                            <h5 class="mb-1">đâsdasd</h5>
                                            <p class="mb-0">đâsdasd Item</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
		                ...
		                <div class="card card-block card-stretch card-height-helf ">
		                    <div class="card-body card-item-right">
		                        <div class="d-flex align-items-top">
		                            <div class="bg-warning-light rounded">
		                                <img src="${contextPath }/images/table/product/ádsadasd" class="style-img img-fluid m-auto" alt="image">
		                            </div>
		                            <div class="style-text text-left">
		                                <h5 class="mb-2">name</h5>
		                                <p class="mb-2">Total Sell : sell %></p>
		                                <p class="mb-0">Total Earned : earned</p>
		                            </div>
		                        </div>
		                    </div>
		                </div>
