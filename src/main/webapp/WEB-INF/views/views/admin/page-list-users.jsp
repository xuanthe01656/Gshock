            ...
            <div class="col-lg-12">
                ...
                <table class="data-table table mb-0 tbl-server-info">
                    ...
                    <c:if test="${not empty listAd }">
                    	<c:forEach items="${listAd }" var="admin">
                    	 <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
                                        href="<%=request.getContextPath()%>/admin/edit-user?id=${admin.id }"><i class="ri-pencil-line mr-0"></i></a>
                                        <c:if test="${users.username ne pageContext.request.userPrincipal.name }">
                                    <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"
                                        href="<%=request.getContextPath()%>/admin/delete-user?id=${admin.id }" ><i onclick="return confirm('Bạn thật sự muốn xóa ?')" class="ri-delete-bin-line mr-0"></i></a>
                                	</c:if>
                                </div>
                            </td>
                        </tr>
