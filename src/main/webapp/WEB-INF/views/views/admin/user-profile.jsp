<%@page import="spring.service.CommentRateService" info="commentRateService" session="true" %>
      ...
      <div class="container-fluid">
               ...
               <div class="card car-transparent">
                  <div class="card-body p-0">
                     <div class="profile-image position-relative">
                        <img src="${contextPath }/images/page-img/profile.png" class="img-fluid rounded w-100" alt="profile-image">
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row m-sm-0 px-3">            
            ...
            <div class="content-page row">
            	<div class="card card-block card-stretch card-height col-sm-12">
                  <div class="card-body">
                     <div class="d-flex align-items-center mb-3">
                        <div class="profile-img position-relative">
                           <img src="${imagePath }/user/${admin.images}" class="img-fluid rounded avatar-110" alt="profile-image">
                        </div>
                        <div class="ml-3">
		                  ...
		                  <div class="tab-content">
		                           ...
		                           <div class="card-body">
		                                 <div class="form-group row align-items-center">
		                                    <div class="col-md-12">
		                                       <div class="profile-img-edit">
		                                          <div class="crm-profile-img-edit change-image">
		                                             <img class="crm-profile-pic rounded-circle avatar-100" id="display_avata" src="${imagePath }/user/${admin.images}" alt="profile-pic">
		                                 ...
		                                 <div class=" row align-items-center">
		                                    ...
		                                    <div class="form-group col-sm-6">
		                                       ...
		                                       <input type="text" class="form-control" id="username" name="username" disabled value="${admin.username }" required>
		                                    </div>
		                                    <div class="form-group col-sm-6">
		                                    ...
		                                    <div class="form-group col-sm-6">
		                                       ...
		                                       <input type="text" class="form-control" name="address" id="city" value="${admin.address }" required>
		                                    </div>
		                                 </div>
		                                 <button type="submit" id="btn-change-profile-admin" class="btn btn-primary mr-2">Update</button>
		                     ...
		                     <div class="tab-pane fade" id="chang-pwd" role="tabpanel">
		                        <div class="card">
		                           ...
		                           <div class="card-body">
		                              <form class="form-admin" id="form-change-password-admin" action="<%=request.getContextPath() %>/admin/change-password" method="post" data-toggle="validator">
		                              <div class="ajax-change-password"></div>
		                                 <div class="form-group">
		                                 <div class="ajax-check-password"></div>
		                                    <label for="cpass">Current Password:</label>
		                                    <div class="ajax-check-password-cpass"></div>
		                                 ...
		                                 <button type="submit" id="btn-change-password-admin" class="btn btn-primary mr-2">Submit</button>
		                                 <button type="reset" class="btn iq-bg-danger">Cancel</button>
		                              </form>
		                           </div>
		                        </div>
		                           ...
		                           <div class="card-body">
		                              <form>
		                                 <div class="form-group">
		                                    ...
		                                    <input type="text" class="form-control" id="cno" value="phone">
		                                 </div>
		                                 <div class="form-group">
		                                    <label for="email">Email:</label>
		                                    <input type="text" class="form-control" id="email-info" value="email">
		                                 </div>
		                                 <div class="form-group">
      	...
      	$('#cpass').on('input', function(){
	   		 ...
	   		 var cpass = $("#cpass").val(); 
			        $.ajax({
						url: '<%=request.getContextPath()%>/admin/check-pass',
						type: 'POST',
						cache: false,
						data: {
								cpass: cpass,
						...
						success: function(data){
							if(data=="2"){
								$('.ajax-check-password-cpass').html("<p style=\"font-style: italic; color: red;\">Mật Khẩu cũ chưa chính xác</p>");
							}else{
								$(".ajax-check-password-cpass").html("");
							}
						},
						error: function (){
							alert('Có lỗi xảy ra');
 			...
 			$('#email').on('blur', function(){
 		   		 var changedField = $(this);
 				     var email = $("#email").val();
 				        $.ajax({
 							url: '<%=request.getContextPath()%>/admin/check-email',
 							type: 'POST',
 							cache: false,
 							data: {
 									email: email,
			...
			messages:{
 			...
 			$( "input[type=file]#avata" ).change(function(e) {
	    		...
	    		if(filename_input!=""){
			    	...
			    	formData.append("pic", avata.files[0]);
			    	$.ajax({
							url: '${pageContext.request.contextPath}/admin/change-avata',
							type: 'POST',
							cache: false,
							contentType: false,
      					data: formData,
      					processData: false,
							success: function(data){
								html ="<img class=\"crm-profile-pic rounded-circle avatar-100\" id=\"display_avata\" src=\"${imagePath }/user/"+data.images+"\" alt=\"profile-pic\">"+
                                "<div class=\"crm-p-image bg-primary\">"+
	                                "<i class=\"las la-pen upload-button\"></i>"+
	                                "<input class=\"file-upload\" type=\"file\" id=\"avata\" name=\"pic\" accept=\"image/*\">"+
                             	"</div>";
								$('.change-image').html(html);
							},
							error: function (){
								alert('Có lỗi xảy ra');
							},
