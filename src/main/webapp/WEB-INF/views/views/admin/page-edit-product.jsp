        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="form" action="${pageContext.request.contextPath}/admin/edit-product?id=${proById.id}&page=${page}" method="post" enctype="multipart/form-data">
                            	...
                            	<div class="col-md-6">
	                                    <div class="form-group">
	                                        ...
	                                        <select name="cat_lv1_id" id="catLV1">
	                                        	...
	                                        	<c:if test="${not empty categoryService.getListCatByPrId(0) }">
	                                        		...
	                                        		<option <c:if test="${proById.cat_lv1_id==catPr.id}">selected</c:if> value="${catPr.id }">${catPr.name }</option>
	                                        		</c:forEach>
	                                        	</c:if>
	                                        </select>
                                    					...
                                    					success: function(data){
                                    						if(data.length>0){
    	                                						...
    	                                						for(i=0; i<data.length; i++){
    	                                							html+='<option /*<c:if test="${prById.cat_lv1_id=='+data[i].id+'}" >selected</c:if>*/ value="'+data[i].id+'">'+data[i].name+'</option>';
    	                                						}
    	                                						html+='</select>';
                                	...
                                	<div class="col-md-6">
	                                    ...
	                                    <label>Category level 2 *</label>
	                                    	<select name="cat_lv2_id">
	                                        <c:if test="${not empty categoryService.getListCatByPrId(proById.cat_lv1_id) }">
	                                        	<c:forEach items="${categoryService.getListCatByPrId(proById.cat_lv1_id) }" var="catChil">
	                                        	<option <c:if test="${proById.cat_lv2_id==catChil.id}">selected</c:if> value="${catChil.id }">${catChil.name }</option>
	                                        	</c:forEach>
	                                        </c:if>
	                                        </select>
	                                    </div> 
                            		...
                            		<div class="col-md-6">
	                                    <div class="form-group">
	                                        ...
	                                        <div id="dataMess"></div>
	                                        <input id="sku" name="product_sku" class="selectpicker form-control" placeholder="Enter SKU" value="${proById.product_sku }" data-style="py-0" data-errors="Please Enter Name.">
	                                ...
	                                <div class="col-md-6">                      
	                                    <div class="form-group">
	                                        <label>Name *</label>
	                                        <input id="name" type="text" class="form-control" placeholder="Enter Name" value="${proById.name }" name="name" data-errors="Please Enter Name.">
                                   ...
                                   <script type="text/javascript">
	                                        $(function() {
	                                		    ...
	                                		    $('#sku').on('blur', function() {
	                                		        ...
	                                		        $.ajax({
	                                					url: '${pageContext.request.contextPath}/admin/handel_productSku_edit',
	                                					type: 'POST',
	                                					cache: false,
	                                					data: {
	                                						sku: sku,
	                              ...
	                              <div class="col-md-6"> 
	                                ...
	                                <div class="col-md-12">                                    
	                                    <div class="form-group">
	                                        ...
	                                        <input type="text" class="form-control" name ="amount" value="${proById.amount }" placeholder="Enter Quantity" required>
	                                ...
	                                <div class="ajax-display-img-input row col-sm-12">
	                                	<div class="col-md-6">
		                                    <div class="form-group">
		                                        <label>Cost *</label>
		                                        <input type="text" class="form-control" name="cost" value="${proById.cost }" placeholder="Enter Cost" data-errors="Please Enter Cost.">
		                                ...
		                                <div class="col-md-6">
		                                    <div class="form-group">
		                                        <label>Price *</label>
		                                        <input type="text" class="form-control" name="price" value="${proById.price }" placeholder="Enter Price" data-errors="Please Enter Price.">
	                                	...
	                                	<div class="col-md-12">
		                                    <div class="form-group">
		                                        ...
		                                        <c:if test="${not empty supplierService.getListSupplier() }">
			                                        ...
			                                        <option <c:if test="${proById.suppliers_id==sup.id}">selected</c:if> value="${sup.id }">${sup.supplier_name }</option>
			                                        </c:forEach>
		                                        </c:if>
		                                        </select>
		                                    </div>
		                                ...
		                                <div class="col-md-12">
		                                    <div class="form-group">
		                                        ...
		                                        <textarea class="form-control ckeditor" name="the_product_set_includes" rows="4">${proById.the_product_set_includes }</textarea>
		                                 ...
		                                 <div class="col-md-12">
		                                    <div class="form-group">
		                                        ...
		                                        <textarea class="form-control ckeditor" name="product_information" rows="4">${proById.product_information}</textarea>
                            ...
                            <button id="btnHd" type="submit" class="btn btn-primary mr-2">Edit Product</button>
