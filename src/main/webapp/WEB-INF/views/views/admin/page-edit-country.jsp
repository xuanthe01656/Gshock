            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <c:if test="${not empty unsuccess }">
                        ...
                        <form id="form" class="form" action="${pageContext.request.contextPath}/admin/edit-country?id=${country.id }" method="post" enctype="multipart/form-data">
                            <div class="row"> 
                                ...
                                <div class="col-md-12">
                                	...
                                	$(function() {
                            		    $('#newcat').on('blur', function() {
                            		        var changedField = $(this);
                            		        var name = $("#newName").val();
                            		        varid = ${country.id}; 
                            		                    
                            		        $.ajax({
                            					url: '<%=request.getContextPath()%>/admin/handel_name_country_edit',
                            					type: 'POST',
                            					cache: false,
                            					data: {
                            						id: id,
                            					...
                            					success: function(data){
                            						if(data=="1"){
                            							$('.ajax-dataname').html("<p style='color:red; font-style: italic'>Tên đã tồn tại.</p>");
                            						}
                            						if(data=="2"){
                            							$('.ajax-dataname').html("<p style='color:green; font-style: italic'>Tên  phép dùng.</p>");
                            						}
                            					},
                            					error: function (){
                            						alert('Có lỗi xảy ra');
