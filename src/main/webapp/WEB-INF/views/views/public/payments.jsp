                        ...
                        <hr class="hr-md">
                            ...
                            <div class="row total-bill">
                   			...
                   			<form id="form-checkout" action="${pageContext.request.contextPath }/public/order" method="Post">
                   				<div class="col-sm-12 col-md-12 col-lg-12"  style="padding: 20px;">
                        			<p class="tex_customer">Thông tin khách hàng</p>
                   				</div>
                   				<div class="col-sm-12 col-md-12 col-lg-12 border_product border-product-sm-large">
		                        <div class="top_border" style="padding: 15px 15px">
		                            <div class="d-flex align-items-center">
		                                <div class="d-flex align-items-center form-check form-check-inline">
		                                    <input class="form-check-input" type="radio" name="user-sex" id="gender_male" value="1" checked="">
		                                    <label class="form-check-label" for="gender_male" style=" margin-top: 7px;padding: 0px 10px;">Anh</label>
		                                </div>
		                                <div class="d-flex align-items-center form-check form-check-inline">
		                                    <input class="form-check-input" type="radio" name="user-sex" id="gender_female" value="2">
		                                    <label class="form-check-label" for="gender_female" style="margin-top: 7px;padding: 0px 10px;">Chị</label>
		                                </div>
		                            </div>
		                            <section>
		                                <div class="form-row mt-2">
		                                    <div class="form-group mb-5px col-md-6">
		                                    	<div id="error_name" style="color: red; font-style: italic;"></div>
		                                        <label class="margin-label">Họ và tên <span class="star-red">*</span></label>
		                                        <input name ="name" style="border-top: none ; border-left: none ; border-right: none; border-radius: 0px;" id="name" type="text" class="form-control form-control-sm buyer_name_v2" placeholder="Nguyễn Văn A">
		                                    </div>
		                                    <div class="form-group mb-5px col-md-6">
		                                    	<div id="error_phone" style="color: red; font-style: italic;"></div>
		                                        <label class="margin-label">Số điện thoại <span class="star-red">*</span></label>
		                                        <input name="phone" style="border-top: none ; border-left: none ; border-right: none; border-radius: 0px;" id="phone" type="text" class="form-control form-control-sm buyer_phone_v2" placeholder="0123456789" inputmode="text">
		                                    </div>
		                                    <div class="form-group mb-5px col-md-12" style="">
		                                        <label class="margin-label">Email </label>
		                                        <input name="email" style="border-top: none ; border-left: none ; border-right: none; border-radius: 0px;" id="email" type="email" class="form-control form-control-sm" placeholder="abc@gmail.com">
		                                        <input id="check_forced_email" type="hidden" value="">
		                                    </div>
		                                </div>
		
		                            </section>
		                            <div class="noti_popup_info mt-3">
		                                <img src="https://pg.baokim.vn/img/icon_v2/icon_info.svg">
		                                <span> Chúng tôi sẽ gửi thông tin liên quan đến đơn hàng tới bạn thông qua email/số điện thoại.</span>
		                            </div>
		                        </div>
		
		                    </div>
		                    <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 20px;">
			                    <p class="tex_customer">Phương thức thanh toán.</p>
			                </div>
			                <div class=" col-sm-12 col-md-12 col-lg-12 border_product border-product-sm">
			                	<div class="d-flex align-items-center">
		                                <div class="d-flex align-items-center form-check form-check-inline">
		                                    <input class="form-check-input" type="radio" name="payment_methods" id="payment_methods" value="COD" checked="">
		                                    <label class="form-check-label" for="payment_methods" style="margin-top: 7px;padding: 0px 10px;">COD</label>
		                                </div>
		                               <c:if test="${not empty objU }">
		                               		<c:if test="${lockxu.surplus<=3000 or lockxu.surplus<(pro.price*pro.qty) }">
		                               		<div class="d-flex align-items-center form-check form-check-inline">
			                                    <input class="form-check-input" type="radio" name="payment_methods" id="payment_methods" value="LOCKXU" disabled="disabled">
			                                    <label class="form-check-label" for="payment_methods" style="margin-top: 7px;padding: 0px 10px;">LOCKXU <small>(Số dư: ${lockxu.surplus }LOCKXU. Chú Ý:Số dư không đủ vui lòng nộp thêm. )</small></label>
		                               		</div>
		                               		</c:if>
		                               		<c:if test="${lockxu.surplus>3000 and lockxu.surplus>(pro.price*pro.qty) }">
		                               		<div class="d-flex align-items-center form-check form-check-inline">
			                                    <input class="form-check-input" type="radio" name="payment_methods" id="payment_methods" value="LOCKXU">
			                                    <label class="form-check-label" for="payment_methods" style="margin-top: 7px;padding: 0px 10px;">LOCKXU <small>(Số dư: ${lockxu.surplus }LOCKXU = ${lockxu.surplus*1000 } VND.  )</small></label>
		                               		</div>
		                               		</c:if>
		                               </c:if>
		                               <c:if test="${empty objU }">
		                               		<div class="d-flex align-items-center form-check form-check-inline">
			                                    <input class="form-check-input" type="radio" name="payment_methods" id="payment_methods" value="LOCKXU" disabled="disabled">
			                                    <label class="form-check-label" for="payment_methods" style="margin-top: 7px;padding: 0px 10px;">LOCKXU <small>(Vui lòng đăng nhập để sử dụng phương thức này.)</small></label>
		                               		</div>
		                               </c:if>
		                          </div>
			                </div>
			                ...
			                <div class=" col-sm-12 col-md-12 col-lg-12 border_product border-product-sm">
		                        <div style="padding: 15px 15px" class="top_border">
		                            <div class="d-flex align-items-center">
		                                <div class="d-flex align-items-center form-check form-check-inline">
		                                    <input class="form-check-input" type="radio" name="ship_type" id="home_delivery" value="home" checked="">
		                                    <label class="form-check-label" for="home_delivery" style="margin-top: 7px;padding: 0px 10px;">Giao hàng tại nhà</label>
		                                </div>
		                                <div class="d-flex align-items-center form-check form-check-inline">
		                                    <input class="form-check-input" type="radio" name="ship_type" id="pickup_store" value="store">
		                                    <label class="form-check-label" for="pickup_store" style="margin-top: 7px;padding: 0px 10px;">Nhận tại cửa hàng</label>
		                                </div>
		                            </div>
		                            ...
		                            <div class="area" style="display: block;">
		                                <div class="row mt-2">
		                                    ...
		                                    <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
		                                        <div class="form-group select-border">
		                                            <label class="margin-label">Quận/Huyện <span class="star-red">*</span></label>
		                                            <select id="district" name="district" class="form-control" data-select2-id="select2-data-district" tabindex="-1" aria-hidden="true">
		                                            </select>
		                                ...
		                                <div class="row">
		                                    <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
		                                        <div class="form-group select-border">
		                                            <label class="margin-label">Phường/Xã<span class="star-red">*</span></label>
		                                            <select id="ward" class="form-control " name="ward"  data-select2-id="select2-data-ward" tabindex="-1" aria-hidden="true">
		                                            </select>
		                                        </div>
		                                    </div>
		                                    <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
		                                        <div class="form-group input-border">
		                                            <label class="margin-label">Đường/Thôn xóm<span class="star-red">*</span></label>
		                                            <input type="text" name="address" class="form-control" id="address" placeholder="Nhập đường/thôn xóm">
		                                        </div>
		                                    </div>
		                            ...
		                            <div class="area-warehouse" style="display: none;">
		                                <div class="row mt-2">
		                                    <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
		                                        <div class="form-group select-border">
		                                            <label class="margin-label">Tỉnh/Thành phố</label>
		                                            <select id="city-warehouse" class="form-control select2-hidden-accessible" data-select2-id="select2-data-city-warehouse" tabindex="-1" aria-hidden="true">
		                                            	<option value="null" data-select2-id="select2-data-4-0c4w">Chọn tất cả</option>
		                                    ...
		                                    <div class="col-sm-12 col-md-12 col-lg-6 mt-2">
		                                        <div class="form-group select-border">
		                                            <label class="margin-label">Quận/Huyện</label>
		                                            <select id="district-warehouse" class="form-control select2-hidden-accessible" data-select2-id="select2-data-district-warehouse" tabindex="-1" aria-hidden="true">
		                                            	<option value="null" data-select2-id="select2-data-4-0c4w">Chọn tất cả</option>
		                                ...
		                                <div class="row mt-2">
		                                    <div class="col-sm-12 col-md-12 col-lg-12 mt-2">
		                                        <div class="form-group select-border">
		                                            <label class="margin-label">Địa chỉ cửa hàng <span class="star-red">*</span></label>
		                                            <div class="form-table-store" style="overflow-x:auto;">
		                                            	<table id="table-address-store" style="border-spacing: 0; display: block ;  border-collapse: separate;">
			                                            	<tr>
																<td class="td-choose-store selected-store with-res" data-id="2372" style="border-radius: 10px; background-color: #ffffff;">
															     	156 Nguyễn Hồng Đào, Phường 14, Quận Tân Bình, Thành phố Hồ Chí Minh
															    </td>
			     											</tr>
		     											</table>
		                                        	</div>
		                    ...
		                    <div class="col-sm-12">
                                	<div class="bk-btn row" style="margin-top: 20px; float: right;">
										<div class="bk-btn-box">
											<button id="home_checkout" type="button" class="bk-btn-paynow" style="display: inline-block;background-color: #e00 !important;color: #fff !important" type="button">
												<strong>Đặt hàng</strong><span>Giao tận nơi hoặc nhận tại cửa hàng</span>
											</button>
										</div>
										<div class="bk-btn-box">
											<div class="mess_err"></div>
											<button id="store_checkout" type="button" class="bk-btn-paynow" style="display: none;background-color: #e00 !important;color: #fff !important" type="button">
												<strong>Đặt hàng</strong><span>Giao tận nơi hoặc nhận tại cửa hàng</span>
											</button>
										</div>
									</div>
...
$('#province').on('change', function(){
	...
	$.ajax({
		url: '${pageContext.request.contextPath}/public/get-districts',
		type: 'POST',
		cache: false,
		data: {code: code,},
		success: function(data){
			if(data.length>0){
				html="<option value='' data-select2-id='select2-data-2-jmtw'>--Chọn Quận Huyện--</option>";
...
$('#district').on('change', function(){
	...
	$.ajax({
		url: '${pageContext.request.contextPath}/public/get-wards',
		type: 'POST',
		cache: false,
		data: {code: code,},
		success: function(data){
			if(data.length>0){
				html="<option value='' data-select2-id='select2-data-2-jmtw'>--Chọn Phường Xã--</option>";
				for(i=0; i<data.length; i++){
					html+='<option value="'+data[i].code+'">'+data[i].name+'</option>'
				}
				$('#ward').html(html);
...
/* $('#form-checkout input[name=ship_type]').on('change', function(){
	ship_typet = $('input[name=ship_type]:checked', '#form-checkout').val();
	if(ship_type==="home"){
		$( "#home_checkout" ).show();
		$( "#store_checkout" ).hide();
	}
...
$( "#store_checkout" ).on( "click", function() {
	var name = $('#name').val();
	var phone = $('#phone').val();
	if(name!=""&&phone!=""){
	  ...
	  $( "#form-checkout" ).submit();
		...
		if(name!=""&&phone==""){
			$( "#error_phone" ).text( "Nhập vào số điện thoại!" ).show().fadeOut( 1000 );
			$(".mess_err").html("<p style=\"color: red; font-style: italic;\">Nhập vào số điện thoại.</p>");
		}else{
			if(name==""&&phone!=""){
				$( "#error_name" ).text( "Nhập vào tên!" ).show().fadeOut( 1000 );
				$(".mess_err").html("<p style=\"color: red; font-style: italic;\">Nhập vào tên.</p>");
			}else{
				$( "#error_name" ).text( "Nhập vào tên!" ).show().fadeOut( 1000 );
				$( "#error_phone" ).text( "Nhập vào số điện thoại!" ).show().fadeOut( 1000 );
				$(".mess_err").html("<p style=\"color: red; font-style: italic;\">Nhập vào thông tin.</p>");
			}
...
$( "#home_checkout" ).on( "click", function() {
	$("#form-checkout").valid();
