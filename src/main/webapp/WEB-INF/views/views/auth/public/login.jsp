...
<div class="woocommerce"><div class="woocommerce-notices-wrapper"></div>
		...
		<form class="woocommerce-form woocommerce-form-login login" action="${pageContext.request.contextPath }/auth/public/login" method="post">
			...
			<p class="form-row">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox woocommerce-form-login__rememberme">
					<input class="woocommerce-form__input woocommerce-form__input-checkbox" name="remember-me" type="checkbox" id="rememberme" value="forever"> <span>Ghi nhớ mật khẩu</span>
				</label>
			...
			<p class="woocommerce-LostPassword lost_password">
				<a href="${pageContext.request.contextPath }/auth/public/check-user">Quên mật khẩu?</a>
			</p>
			<p class="woocommerce-LostPassword lost_password">
